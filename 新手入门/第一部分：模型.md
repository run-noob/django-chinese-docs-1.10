...
如果你想深入研究正则表达式，可以参考[Wikipedia’s entry](https://en.wikipedia.org/wiki/Regular_expression) 以及 [re](https://docs.python.org/3/library/re.html#module-re) 模块的文档，由作者Jeffrey Friedl出版的O’Reilly  “Mastering Regular Expressions”书籍也非常不错，但是在Django的实践中，你不需要多高深的正则表达式知识。
